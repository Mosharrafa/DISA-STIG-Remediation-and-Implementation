<#
.SYNOPSIS
    This PowerShell script configures the lockout observation window (reset counter) to 15 minutes.
.NOTES
    Author          : Mosharrafa
...
Write-Host "WN11-AC-000015 applied: Reset counter = $window minutes"
