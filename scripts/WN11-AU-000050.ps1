<#
.SYNOPSIS
    This PowerShell script enables Process Creation success auditing.
.NOTES
    Author          : Mosharrafa
...
# Define the audit subcategory and setting
$auditSubcategory = "Process Creation"
$successSetting = "enable"

# Apply the audit policy
auditpol /set /subcategory:"$auditSubcategory" /success:$successSetting

# Output success message
Write-Host "WN11-AU-000050 applied: Process Creation success auditing enabled"
