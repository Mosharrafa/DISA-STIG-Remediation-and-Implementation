<#
.SYNOPSIS
    This PowerShell script enables Sensitive Privilege Use success auditing.
.NOTES
    Author          : Mosharrafa
...
Write-Host "WN11-AU-000587 applied: Sensitive Privilege Use success auditing enabled"
