<#
.SYNOPSIS
    This PowerShell script enables Sensitive Privilege Use failure auditing.
.NOTES
    Author          : Mosharrafa
...
Write-Host "WN11-AU-000588 applied: Sensitive Privilege Use failure auditing enabled"
