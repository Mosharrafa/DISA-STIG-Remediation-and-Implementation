<#
.SYNOPSIS
    This PowerShell script disables WDigest Authentication to prevent plain-text credentials in LSASS memory.
.NOTES
    Author          : Mosharrafa
...
Write-Host "WN11-CC-000038 applied: WDigest disabled"
